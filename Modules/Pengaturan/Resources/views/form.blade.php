...
@section('content')
<form method="POST" action="{{ BeUrl(config('pengaturan.info.alias').'/save') }}" enctype="multipart/form-data">

    <div class="row">
        <div class="col-md-4">
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> {{ trans('pengaturan::global.image') }} </h3>
                    <a href="#" class="btn btn-sm btn-flat btn-default pull-right" id="changeImage"><i class="fa fa-pencil"></i> {{ trans('pengaturan::global.change_image') }} </a>
                </div><!-- /.box-header -->
                <div class="box-body">
        ...
        <div class="col-md-8">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group has-feedback">
                        <label>{{ trans('pengaturan::global.title') }}</label><span class="char_count"></span>
                    ...
                    <a href="{{ BeUrl(config('pengaturan.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
