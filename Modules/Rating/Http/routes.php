...
//BACKEND
Route::group(['middleware' => 'web', 'prefix' => config('app.backend').'/'.$info['alias'], 'namespace' => 'Modules\Rating\Http\Controllers'], function()
{
...
//FRONT END
Route::group(['middleware'=>'web', 'prefix' => $info['alias'], 'namespace' => 'Modules\Rating\Http\Controllers'], function()
{
    Route::post('/save', 'FeController@save');
    Route::post('/more', 'FeController@more');
});