        ...
        <div class="col-md-8">
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data {{ config('rating.info.name') }} </h3>
                </div><!-- /.box-header -->
                <div class="box-body no-padding">
                  <table class="table table-striped table-bordered" id="list-table" data-url="{{ BeUrl(config('rating.info.alias')) }}" data-token="{{ csrf_token() }}">
                    <thead>
                    <tr>
                      ...
                      <th data-sort="1" data-search="1" data-column="rating" class="col-md-1 nowrap">{{ trans('rating::global.rating') }}</th>
                      <th data-sort="1" data-search="1" data-column="status" class="col-md-1 nowrap">{{ trans('global.status') }}</th>
                      <th data-sort="1" data-search="1" data-column="created_at" class="col-md-1 nowrap">{{ trans('rating::global.created_at') }}</th>
