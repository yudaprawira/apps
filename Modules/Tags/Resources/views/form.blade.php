    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{ BeUrl(config('tags.info.alias').'/save') }}" id="formData" <form method="POST" action="{{ BeUrl(config('book.info.alias').'/save') }}" enctype="multipart/form-data">
                ...
                <div class="form-group has-feedback">
                    <label>{{ trans('tags::global.tags') }}</label><span class="char_count"></span>
                    <input type="text" class="form-control" name="tags" maxlength="125" value="{{ val($dataForm, 'tags') }}" />
                </div>
                ...
                <a href="{{ BeUrl(config('tags.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                </form>
