    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{ BeUrl(config('tag.info.alias').'/save') }}" id="formData">
                ...
                <div class="form-group has-feedback">
                    <label>{{ trans('tag::global.tag') }}</label><span class="char_count"></span>
                    <input type="text" class="form-control" name="tag" maxlength="125" value="{{ val($dataForm, 'tag') }}" />
                </div>
                ...
                <a href="{{ BeUrl(config('tag.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                </form>
