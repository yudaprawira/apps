        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="{{ BeUrl(config('halaman.info.alias').'/save') }}">
                    ...
                    <div class="form-group has-feedback">
                        <label>{{ trans('halaman::global.title') }}</label><span class="char_count"></span>
                        <input type="text" class="form-control" name="title" maxlength="125" value="{{ val($dataForm, 'title') }}" />
                    </div>
                    <div class="form-group has-feedback">
                        <label>{{ trans('halaman::global.text') }}</label><span class="char_count"></span>
                    ...
                    <a href="{{ BeUrl(config('halaman.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                  </form>
