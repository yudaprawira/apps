    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{ BeUrl(config('wishlist.info.alias').'/save') }}" id="formData">
                ...
                <a href="{{ BeUrl(config('wishlist.info.alias').'/edit/0') }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                </form>
