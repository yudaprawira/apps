...
class BeController extends BaseController
{
    ...
    */
    public function index()
    {
        if ( Request::isMethod('get') )
        {
            ...
            return view('wishlist::index', $this->dataView);
        }
        else
        {
            return Datatables::of(Wishlist::with('member'))
    ...
    */
    public function form($id='')
    {
        ...
        return view('wishlist::form', $this->dataView);
    }
    ...
    */
    function delete($id)
    {
        return Response()->json([ 
            'status' => $this->_deleteData(new Wishlist(), $id), 
    ...
    */
    function save()
    {
        ...
        $status = $this->_saveData( new Wishlist(), [   
            //VALIDATOR
            "member_id"=>"required"
        ], $input, 'item');
