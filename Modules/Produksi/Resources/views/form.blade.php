...
@section('content')
<form method="POST" action="{{ BeUrl(config('produksi.info.alias').'/save') }}" enctype="multipart/form-data">

    <div class="row">
        <div class="col-md-4">
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> {{ trans('produksi::global.image') }} </h3>
                    <a href="#" class="btn btn-sm btn-flat btn-default pull-right" id="changeImage"><i class="fa fa-pencil"></i> {{ trans('produksi::global.change_image') }} </a>
                </div><!-- /.box-header -->
                <div class="box-body">
        ...
        <div class="col-md-8">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group has-feedback">
                        <label>{{ trans('produksi::global.produksi') }}</label><span class="char_count"></span>
                        <input type="text" class="form-control" name="produksi" maxlength="125" value="{{ val($dataForm, 'produksi') }}" />
                    </div>
                    ...
                    <a href="{{ BeUrl(config('produksi.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
