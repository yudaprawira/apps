    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="<?php echo e(BeUrl(config('akunbank.info.alias').'/save')); ?>" id="formData">
                ...
                <div class="form-group has-feedback">
                    <label><?php echo e(trans('akunbank::global.nama')); ?></label><span class="char_count"></span>
