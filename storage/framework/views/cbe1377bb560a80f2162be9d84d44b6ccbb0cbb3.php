            ...
            <div class="box box-default collapsed-box">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title" style="padding-left: 20px;"> FILTER
                    <a class="btn btn-primary flat" target="_blank" href="<?php echo e(url('/laporan-pegawai/print'.(isset($_SERVER['QUERY_STRING']) ? '?'.$_SERVER['QUERY_STRING'] : ''))); ?>" style="position: absolute; right: 5px;top: 3px;"> <i class="fa fa-print"></i> <?php echo e(trans('global.print')); ?></a>
                  </h3>        
                </div>
                <!-- /.box-header -->
...
$(function() {
    var oTable = $('#list-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '".url('/laporan-pegawai'.(isset($_SERVER['QUERY_STRING']) ? '?'.$_SERVER['QUERY_STRING'] : ''))."',
            method: 'POST',
            data: {
                '_token': '".csrf_token()."',
            }
