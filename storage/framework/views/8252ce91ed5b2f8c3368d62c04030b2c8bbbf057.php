    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="<?php echo e(BeUrl(config('mbahjomblo.info.alias').'/save')); ?>" id="formData" <form method="POST" action="<?php echo e(BeUrl(config('book.info.alias').'/save')); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group has-feedback">
                    <label><?php echo e(trans('mbahjomblo::global.mbah')); ?></label><span class="char_count"></span>
                    <input type="text" class="form-control" name="mbah" maxlength="125" value="<?php echo e(val($dataForm, 'mbah')); ?>" />
                </div>
                ...
                <a href="<?php echo e(BeUrl(config('mbahjomblo.info.alias').'/edit/0')); ?>" class="btn btn-default btn-flat btn-reset"><?php echo e(trans('global.act_back')); ?></a>
                </form>
