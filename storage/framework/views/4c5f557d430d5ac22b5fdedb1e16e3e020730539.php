<form method="POST" action="<?php echo e(url('laporan-penggajian/save')); ?>" class="form-gaji" data-type="bln">
    <?php if( !$print ): ?>
          ...
          <div class="modal-body">
            ...
            <table class="table table-condensed ">
                ...
                <tr> <td class="key">BPJS JHT <small>(<?php echo e(config('produksi.pot_bpjs_jht')); ?>%)</small></td> <td class="sep">:</td> <td class="val text-right">
                    ...
                    <input type="text" maxlength="9" disabled="1" value="<?php echo e(formatNumber($pot_bpjs_jht)); ?>" class="form-control slip-input tNum input-min" name="atribut[pot_bpjs_jht]" />
                </td> </tr>
                <tr> <td class="key">BPJS KES <small>(<?php echo e(config('produksi.pot_bpjs_kes')); ?>%)</small></td> <td class="sep">:</td> <td class="val text-right">
                    ...
                    <input type="text" maxlength="9" disabled="1" value="<?php echo e(formatNumber($pot_bpjs_kes)); ?>" class="form-control slip-input tNum input-min" name="atribut[pot_bpjs_kes]" />
                </td> </tr>
                <tr> <td class="key">Pensiun <small>(<?php echo e(config('produksi.pot_bpjs_pns')); ?>%)</small></td> <td class="sep">:</td> <td class="val text-right border-bottom">
                    ...
                    <input type="text" maxlength="9" disabled="1" value="<?php echo e(formatNumber($pot_bpjs_pns)); ?>" class="form-control slip-input tNum input-min" name="atribut[pot_bpjs_pns]" />
                </td> </tr>
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            <tr> <td>JL.1</td> <td style="width: 100px;">
                                <input type="text" disabled="1" maxlength="6" data-target=".lbl-lbr-1" value="<?php echo e(formatNumber($jam_jl1,2)); ?>" class="form-control input-jam-lembur slip-input tDec" name="bulanan[jl1]" />
                            </td> <td>
                            ...
                            <tr> <td>JL.2</td> <td style="width: 100px;">
                                <input type="text" disabled="1" maxlength="6" data-target=".lbl-lbr-2" value="<?php echo e(formatNumber($jam_jl2,2)); ?>" class="form-control input-jam-lembur slip-input tDec" name="bulanan[jl2]" />
                            </td> <td>
                            ...
                            <tr> <td>JL.3</td> <td style="width: 100px;">
                                <input type="text" disabled="1" maxlength="6" data-target=".lbl-lbr-3" value="<?php echo e(formatNumber($jam_jl3,2)); ?>" class="form-control input-jam-lembur slip-input tDec" name="bulanan[jl3]" />
                            </td> <td>
                            ...
                            <tr> <td>JL.4</td> <td style="width: 100px;">
                                <input type="text" disabled="1" maxlength="6" data-target=".lbl-lbr-4" value="<?php echo e(formatNumber($jam_jl4,2)); ?>" class="form-control input-jam-lembur slip-input tDec" name="bulanan[jl4]" />
                            </td> <td>
