                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          result : <?php echo e(echoPre(['a'=>'Apple', 'b'=>'Banana'])); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          result : <?php echo createLink('http://google.com', 'link to google', '_blank', 'text-danger'); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          result : <?php echo linkable('link to google', 'http://google.com'); ?>

                          <br/><br/>
                          <sc>linkable('link to google', '')</sc>
                          result : <?php echo linkable('link to google', ''); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          Detail Log can be access in <?php echo createLink(BeUrl('system-log'), 'Here'); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          result : <?php echo e(formatNumber(1000, $dec=0, true)); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <sc>
                          $row = <?php echo e(echoPre( ['author'=>['name'=>'Yuda Prawira', 'site'=>'http://yuda.tk']] )); ?>

                          val($row, 'author.name')
                          </sc>
                          result : <?php echo e(val(['author'=>['name'=>'Yuda Prawira', 'site'=>'http://yuda.tk']], 'author.name')); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          result : <?php echo e(echoPre(getRowArray(App\Models\System\User::all(), 'id', 'username'))); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          result : <?php echo text('test text', true, 'text-success', 'text-danger'); ?>

                          <br/><br/>
                          <sc>
                          text($text, $isEnable=false, $enabledClass='', $disabledClass='')
                          </sc>
                          result : <?php echo text('test text', false, 'text-success', 'text-danger'); ?>
