<div class="box">
    ...
    <div class="box-body">
        <form role="form" action="<?php echo e(BeUrl('system-level/save')); ?>" method="POST" id="formData">
            ...
            <a href="<?php echo e(BeUrl('system-level/edit/0')); ?>" class="btn btn-default btn-flat btn-reset"><?php echo e(trans('global.act_cancel')); ?></a>
        </form>
    </div>
</div>