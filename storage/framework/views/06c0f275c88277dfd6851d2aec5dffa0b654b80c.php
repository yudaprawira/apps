<div class="box">
    ...
    <div class="box-body">
        <form role="form" action="<?php echo e(BeUrl('system-user/save')); ?>" method="POST" id="formData">
            ...
            <a href="<?php echo e(BeUrl('system-user/edit/0')); ?>" class="btn btn-default btn-flat btn-reset"><?php echo e(trans('global.act_cancel')); ?></a>
        </form>
    </div>
</div>