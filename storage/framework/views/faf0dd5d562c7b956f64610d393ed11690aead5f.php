            ...
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="<?php echo e(BeUrl(config('pesanan.info.alias').'/save')); ?>">
                    ...
                    <div class="form-group has-feedback">
                        <label><?php echo e(trans('pesanan::global.invoice')); ?></label><span class="char_count"></span>
                        <input type="text" class="form-control" name="invoice" maxlength="125" value="<?php echo e(val($dataForm, 'invoice')); ?>" />
                    </div>
