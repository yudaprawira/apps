        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="<?php echo e(BeUrl(config('produk.info.alias').'/save')); ?>">
                    ...
                    <div class="form-group has-feedback">
                        <label><?php echo e(trans('produk::global.produkku')); ?></label><span class="char_count"></span>
                        <input type="text" class="form-control" name="produkku" maxlength="125" value="<?php echo e(val($dataForm, 'produkku')); ?>" />
                    </div>
                    ...
                    <a href="<?php echo e(BeUrl(config('produk.info.alias'))); ?>" class="btn btn-default btn-flat btn-reset"><?php echo e(trans('global.act_back')); ?></a>
                  </form>
