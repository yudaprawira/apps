    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="<?php echo e(BeUrl(config('tg.info.alias').'/save')); ?>" id="formData">
                ...
                <div class="form-group has-feedback">
                    <label><?php echo e(trans('tg::global.tag')); ?></label><span class="char_count"></span>
                ...
                <a href="<?php echo e(BeUrl(config('tg.info.alias'))); ?>" class="btn btn-default btn-flat btn-reset"><?php echo e(trans('global.act_back')); ?></a>
                </form>
