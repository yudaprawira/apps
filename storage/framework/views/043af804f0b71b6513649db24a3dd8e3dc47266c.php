    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="<?php echo e(BeUrl(config('wishlist.info.alias').'/save')); ?>" id="formData">
                ...
                <a href="<?php echo e(BeUrl(config('wishlist.info.alias').'/edit/0')); ?>" class="btn btn-default btn-flat btn-reset"><?php echo e(trans('global.act_back')); ?></a>
                </form>
