        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="<?php echo e(BeUrl(config('abcdef.info.alias').'/save')); ?>">
                    ...
                    <div class="form-group has-feedback">
                        <label><?php echo e(trans('abcdef::global.nama_field')); ?></label><span class="char_count"></span>
                        <input type="text" class="form-control" name="nama_field" maxlength="125" value="<?php echo e(val($dataForm, 'nama_field')); ?>" />
                    </div>
                    ...
                    <a href="<?php echo e(BeUrl(config('abcdef.info.alias'))); ?>" class="btn btn-default btn-flat btn-reset"><?php echo e(trans('global.act_back')); ?></a>
                  </form>
