...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e($pub_url); ?>/plugins/iCheck/flat/blue.css">
    <!-- jvectormap -->
    ...
    <script>
        ...
        $(function() {    
            if ( $('#list-table').length>0 )
            {
                ...
                var objTblColumn = [];
                objTbl.find('thead th').each(function(){
                    objTblColumn.push({ 'data': $(this).data('column'), 'orderable': $(this).data('sort') , 'searchable': $(this).data('search') });    
                });
