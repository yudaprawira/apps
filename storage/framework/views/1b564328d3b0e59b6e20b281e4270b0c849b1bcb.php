...
<!-- StyleSheets -->
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/animate.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/icomoon.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/main.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/color-1.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/style.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/responsive.css">
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/transition.css">
<link rel="stylesheet" href="<?php echo e(asset('/global/css/star.css')); ?>"/> 
...
<!-- Online Lib -->
<link rel="stylesheet" href="<?php echo e($pub_url); ?>/css/tether.min.css">
<script src="<?php echo e($pub_url); ?>/js/tether.min.js"></script>

<!-- Switcher CSS -->
<link href="<?php echo e($pub_url); ?>/css/switcher.css" rel="stylesheet" type="text/css"/> 
<link rel="stylesheet" id="skins" href="<?php echo e($pub_url); ?>/css/default.css" type="text/css" media="all">
...
<!-- JavaScripts -->
<script src="<?php echo e($pub_url); ?>/js/modernizr.js"></script>
</head>
<body>
		...
		<nav class="nav-holder style-1">
			<div class="container">
				<div class="mega-dropdown-wrapper">
					...
					<!-- Logo -->
					<div class="logo">
						<a href="index.html"><img src="<?php echo e($pub_url); ?>/png/logo-1.png" alt=""></a>
					</div>
					<!-- Logo -->
												...
												<div class="col-sm-6">
													<div class="row">
														<div class="col-sm-4">
															<div class="s-product">
																<div class="s-product-img">
																	<img src="<?php echo e($pub_url); ?>/jpg/img-01.jpg" alt="">
																</div>
														...
														<div class="col-sm-4">
															<div class="s-product">
																<div class="s-product-img">
																	<img src="<?php echo e($pub_url); ?>/jpg/img-02.jpg" alt="">
																</div>
																<span>James oliver</span>
															</div>
														</div>
														<div class="col-sm-4">
															<div class="s-product">
																<div class="s-product-img">
																	<img src="<?php echo e($pub_url); ?>/jpg/img-03.jpg" alt="">
																</div>
																<span>James oliver</span>
															</div>
														</div>
	    ...
	    <div class="footer-columns">
	    	<div class="container">
	    		...
	    		<div class="footer-ad-banner">
	    			<a href="#"><img src="<?php echo e($pub_url); ?>/jpg/footer-ad-banner.jpg" alt=""></a>
	    		</div>
	    		<!-- Add banner -->
	    		...
	    		<div class="row">
		    		...
		    		<div class="col-lg-4 col-sm-6">
		    			<div class="footer-column logo-column">
		    				<a href="index-1.html"><img src="<?php echo e($pub_url); ?>/png/logo-2.png" alt=""></a>
	   		...
	   		<div class="container">
	   			<div class="row">
		   			...
		   			<div class="col-sm-6">
		   				...
		   				<ul class="cards-list">
		   					<li><img src="<?php echo e($pub_url); ?>/jpg/img-39.jpg" alt=""></li>
		   					<li><img src="<?php echo e($pub_url); ?>/jpg/img-40.jpg" alt=""></li>
		   					<li><img src="<?php echo e($pub_url); ?>/jpg/img-41.jpg" alt=""></li>
		   					<li><img src="<?php echo e($pub_url); ?>/jpg/img-42.jpg" alt=""></li>
		   				</ul>
		   			</div>
	   			</div>
	   		</div>
...
<nav id="menu" class="responive-nav">
	<a class="r-nav-logo" href="index.html"><img src="<?php echo e($pub_url); ?>/png/logo-1.png" alt=""></a>
...
<div class="modal fade open-book-view" id="open-book-view" role="dialog">
  	<div class="position-center-center" role="document">
	    	...
	    	<div id="magazine">
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/01.jpg);"></div>
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/02.jpg);"></div>
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/03.jpg);"></div>
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/04.jpg);"></div>
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/04.jpg);"></div>
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/05.jpg);"></div>
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/05.jpg);"></div>
				<div style="background-image:url(<?php echo e($pub_url); ?>/jpg/06.jpg);"></div>
			</div>
    	</div>
  	</div>
</div>
		...
		<div class="modal-content">
			...
			<form class="sending-form formAccountLogin"  method="POST" action="<?php echo e(url('member/do-login')); ?>">
				...
				<div class="text-center">
					<i>Belum punya akun? <a href="<?php echo e(url('member/register?next='.urlencode(val($_GET,'next')))); ?>" target="_blank">daftar sekarang</a></i>
				</div>
		...
		<div class="modal-content">
			...
			<div id="quickviewContent">
				<div class="text-center">
					...
					<img src="<?php echo e(asset('global/images/loading_bar.gif')); ?>"/>
				</div>
			<div>
		</div>
	</div>
...
<!-- Java Script -->
<?php if($path!=''): ?>
<script src="<?php echo e($pub_url); ?>/js/jquery.min.js"></script>        
<?php else: ?>
<script src="<?php echo e($pub_url); ?>/js/jquery.js"></script>        
<?php endif; ?>
<script src="<?php echo e($pub_url); ?>/js/bootstrap.min.js"></script>
<!--script src="http://maps.google.com/maps/api/js?sensor=false"></script-->
<script src="<?php echo e($pub_url); ?>/js/gmap3.min.js"></script>					
<script src="<?php echo e($pub_url); ?>/js/datepicker.js"></script>					
<script src="<?php echo e($pub_url); ?>/js/contact-form.js"></script>					
<script src="<?php echo e($pub_url); ?>/js/bigslide.js"></script>							
<script src="<?php echo e($pub_url); ?>/js/3d-book-showcase.js"></script>					
<script src="<?php echo e($pub_url); ?>/js/turn.js"></script>							
<script src="<?php echo e($pub_url); ?>/js/jquery-ui.js"></script>								
<script src="<?php echo e($pub_url); ?>/js/mcustom-scrollbar.js"></script>					
<script src="<?php echo e($pub_url); ?>/js/timeliner.js"></script>					
<script src="<?php echo e($pub_url); ?>/js/parallax.js"></script>			   	 
<script src="<?php echo e($pub_url); ?>/js/countdown.js"></script>	
<script src="<?php echo e($pub_url); ?>/js/countto.js"></script>		
<script src="<?php echo e($pub_url); ?>/js/owl-carousel.js"></script>	
<script src="<?php echo e($pub_url); ?>/js/bxslider.js"></script>	
<script src="<?php echo e($pub_url); ?>/js/appear.js"></script>		 		
<script src="<?php echo e($pub_url); ?>/js/sticky.js"></script>			 		
<script src="<?php echo e($pub_url); ?>/js/prettyphoto.js"></script>			
<script src="<?php echo e($pub_url); ?>/js/isotope.pkgd.js"></script>					 
<script src="<?php echo e($pub_url); ?>/js/wow-min.js"></script>			
<script src="<?php echo e($pub_url); ?>/js/classie.js"></script>					
<script src="<?php echo e($pub_url); ?>/js/main.js"></script>
<script src="<?php echo e(asset('/global/js/jquery.bootstrap-growl.min.js')); ?>"></script>
<script src="<?php echo e(asset('/global/js/star.js')); ?>"></script>
						...
						if ( dt.status == true )
						{
							if ( dt.redirect ) 
							{
								if ( dt.redirect.indexOf("logout")  )
									window.location.href = '<?php echo e(url('member')); ?>';
								else
