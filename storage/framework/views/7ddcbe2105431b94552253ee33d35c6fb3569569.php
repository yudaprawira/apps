<table class="table table-bordered table-hover table-striped table-condensed box"  style="background: #fff;" changed="0" id="tb-eblek">
    ...
    <tbody>
        ...
        <tr>
            ...
            ?>
            <?php if ( $disable ) { ?>
            <td style="padding: 0;" colspan="3"><input disabled="1" type="text" class="form-control" name="produk_plan[<?php echo e($id); ?>][<?php echo e($v['dt']); ?>]" value="<?php echo e(isset($row_eblek['detail']['plan'][$id][$v['dt']]) ? formatNumber($row_eblek['detail']['plan'][$id][$v['dt']]) : formatNumber(config('produksi.qty_plan'))); ?>" /></td>
            <td style="padding: 0;" colspan="3"><input disabled="1" type="text" <?=$disable?> class="form-control" name="produk_actual[<?php echo e($id); ?>][<?php echo e($v['dt']); ?>]" value="<?php echo e(isset($row_eblek['detail']['actual'][$id][$v['dt']]) ? formatNumber($row_eblek['detail']['actual'][$id][$v['dt']]) : ''); ?>" /></td>
            <?php } elseif ( $pr['keterangan']=='H' ) { ?>
            <td style="padding: 0;" colspan="3"><input disabled="1" type="text" class="form-control tNum" name="produk_plan[<?php echo e($id); ?>][<?php echo e($v['dt']); ?>]" value="<?php echo e(isset($row_eblek['detail']['plan'][$id][$v['dt']]) ? formatNumber($row_eblek['detail']['plan'][$id][$v['dt']]) : formatNumber(config('produksi.qty_plan'))); ?>" /></td>
            <td style="padding: 0;" colspan="3"><input disabled="1" type="text" class="form-control tNum product_actual <?= isset($pr['lembur']) && $pr['lembur']>0 ? 'bgGreen-'.intval($pr['lembur']) : '' ?>" <?= isset($pr['lembur']) && $pr['lembur']>0 ? 'data-toggle="modal" data-target=".modal-lembur-'.$id.'-'.$v['dt'].'"' : ''?> name="produk_actual[<?php echo e($id); ?>][<?php echo e($v['dt']); ?>]" value="<?php echo e(isset($row_eblek['detail']['actual'][$id][$v['dt']]) ? formatNumber($row_eblek['detail']['actual'][$id][$v['dt']]) : ''); ?>" />
