        ...
        <section class="row-fluid">
            <section class="span8 offset2 cart-holder">
                ...
                <div class="well" style="border-radius: 0;">
                    <form id="formAccount" method="POST" action="{{ url('member/do-register') }}">
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                ...
                                <div class="control-group form-group">
                                    ...
                                    <div class="controls has-feedback">
                                        <input class="span12" type="password" required name="password" maxlength="255" placeholder="" class=" ">
                                    </div>
                                </div>
                                <div class="control-group form-group">
                                    <label class="control-label">Ulangi Password <sup>*</sup> <span class="char_count"></span></label>
                                    <div class="controls has-feedback">
                                        <input class="span12" type="password" required name="ulangi_password" maxlength="255" placeholder="" class=" ">
                                    </div>
                                </div>
                            </div>
                            <div class="span6">
                        ...
                        <div class="text-center">
                            <input type="hidden" name="_next" value="{{ val($_GET,'next') }}" />
                        ...
                        <br/><br/>
                        <div class="text-center">
                            <i>Sudah punya akun? <a href="{{ url('member/login?next='.urlencode(val($_GET,'next'))) }}">login di sini</a></i>
                        </div>
                    </div>
                </div>
            </section>
