<div class="well" style="border-radius: 0;">
    <form id="formAccount" method="POST" action="{{ url('member/do-update') }}">
            ...
            <div class="col-md-6">
                <div class="control-group form-group">
                    ...
                    <div class="controls has-feedback">
                        <input class="form-control" type="text" name="nama" value="{{ Session::get('member_nama') }}" maxlength="75" placeholder="" class=" " required>
                    </div>
                </div>
                <div class="control-group form-group">
                    <label class="control-label">Email <sup>*</sup> <span class="char_count"></span></label>
                    <div class="controls has-feedback">
                        <input class="form-control" type="email" name="email" value="{{ Session::get('member_email') }}" maxlength="75" placeholder="" class=" " required>
                    </div>
                </div>
                <div class="control-group form-group">
                    <label class="control-label">Telepon <sup>*</sup> <span class="char_count"></span></label>
                    <div class="controls has-feedback">
                        <input class="form-control" type="text" value="{{ Session::get('member_telepon') }}" required name="telepon" maxlength="20" placeholder="" class=" ">
                    </div>
                </div>
                <div class="control-group form-group">
                    <label class="control-label">Kode Pos <span class="char_count"></span></label>
                    <div class="controls has-feedback">
                        <input class="form-control" type="text" value="{{ Session::get('member_kodepos') }}" name="kodepos" maxlength="5" placeholder="" class=" ">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="control-group form-group">
                    ...
                    <div class="controls has-feedback">
                        <textarea class="form-control" style="height: 116px;" name="alamat" maxlength="255" placeholder="" class=" " required>{{ Session::get('member_alamat') }}</textarea>
                    </div>
                </div>
                <div class="control-group form-group">
                    <label class="control-label">Provinsi <sup>*</sup> <span class="char_count"></span></label>
                    <div class="controls has-feedback">
                        <input class="form-control" type="text"  value="{{ Session::get('member_provinsi') }}" name="provinsi" maxlength="30" placeholder="" class=" " required>
                    </div>
                </div>
                <div class="control-group form-group">
                    <label class="control-label">Kota <sup>*</sup> <span class="char_count"></span></label>
                    <div class="controls has-feedback">
                        <input class="form-control" type="text" name="kota" value="{{ Session::get('member_kota') }}" maxlength="35" placeholder="" class=" " required>
                    </div>
                </div>
