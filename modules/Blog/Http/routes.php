...
//BACKEND
Route::group(['middleware' => 'web', 'prefix' => config('app.backend').'/'.$info['alias'], 'namespace' => 'Modules\Blog\Http\Controllers'], function()
{
...
//FRONT END
Route::group(['prefix' => $info['alias'], 'namespace' => 'Modules\Blog\Http\Controllers'], function()
{
