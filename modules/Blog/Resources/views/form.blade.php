        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="{{ BeUrl(config('blog.info.alias').'/save') }}">
                    ...
                    <div class="form-group has-feedback">
                        <label>{{ trans('blog::global.judul') }}</label><span class="char_count"></span>
                    ...
                    <a href="{{ BeUrl(config('blog.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                  </form>
