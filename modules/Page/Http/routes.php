...
//BACKEND
Route::group(['middleware' => 'web', 'prefix' => config('app.backend').'/'.$info['alias'], 'namespace' => 'Modules\Page\Http\Controllers'], function()
{
...
//FRONT END
Route::group(['prefix' => $info['alias'], 'namespace' => 'Modules\Page\Http\Controllers'], function()
{
