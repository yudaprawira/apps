        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="{{ BeUrl(config('blogspot.info.alias').'/save') }}">
                    ...
                    <div class="form-group has-feedback">
                        <label>{{ trans('blogspot::global.judule_blog') }}</label><span class="char_count"></span>
                        <input type="text" class="form-control" name="judule_blog" maxlength="125" value="{{ val($dataForm, 'judule_blog') }}" />
                    </div>
                    ...
                    <a href="{{ BeUrl(config('blogspot.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                  </form>
