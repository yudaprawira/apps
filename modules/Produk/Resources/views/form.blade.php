        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="POST" action="{{ BeUrl(config('produk.info.alias').'/save') }}">
                    ...
                    <div class="form-group has-feedback">
                        <label>{{ trans('produk::global.nama_produk') }}</label><span class="char_count"></span>
                        <input type="text" class="form-control" name="nama_produk" maxlength="125" value="{{ val($dataForm, 'nama_produk') }}" />
                    </div>
                    ...
                    <a href="{{ BeUrl(config('produk.info.alias')) }}" class="btn btn-default btn-flat btn-reset">{{ trans('global.act_back') }}</a>
                  </form>
